...
public class CountryServiceImpl implements CountryService {
    ...
    @Autowired
    CountryServiceImpl(CountryRepository countryRepository, Gson gson, ModelMapper modelMapper, ValidationUtil validationUtil) {
    ...
    public String importCountries() throws IOException {
        ...
        for (CountryImportDto countryImportDto : countryImportDtos) {
            ...
            sb.append(String.format("Successfully imported country " +
                    "%s - %s", countryImportDto.getName(), countryImportDto.getCapital()))
